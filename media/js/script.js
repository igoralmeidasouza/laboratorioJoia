...
function updateFilteredPagamentos(data) {
    // Inicializa a string HTML da tabela ---- AQUI
    let tableHTML = "<table class='tabelaGeral tabelaConsultarExtratos'><thead><tr><th>ID</th><th>Data</th><th>Observação</th><th>Total</th><th>Saldo Anterior</th><th>Saldo Atual</th></tr></thead><tbody>";
