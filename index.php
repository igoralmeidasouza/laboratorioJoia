...
<head>
    ...
    <link rel="stylesheet" href="media/css/estilos.css?<?php echo MEDIA_VERSION; ?>">
    ...
    <script src="https://code.jquery.com/jquery-3.6.4.min.js?<?php echo MEDIA_VERSION; ?>"></script>
    <script src="/laboratorioJoia/media/js/script.js?<?php echo MEDIA_VERSION; ?>"></script>
    <script src="/laboratorioJoia/media/js/jquery.js?<?php echo MEDIA_VERSION; ?>"></script>
                ...
                <div class="formularios">
                    ...
                    <form id="salesForm" class="formularioGeral formularioRealizarVenda">
                        ...
                        <div class="inputMesmaLinha">
                            ...
                            <div class="botaoCarrinho" onclick="addToCart()" id="botaoCarrinho">
                                <span>adicionar</span>
                        ...
                        <div class="dentadura">
                            ...
                            <style>
                                .dentadura{position: relative; width: 100%; overflow-x: clip; margin-top: 13px;}
                                    .dentadura .content{width: 100%;display: flex;border-top: solid 1px lightgrey;padding-top: 25px;gap: 30px;flex-direction: row-reverse;}

                                    .dentadura .content .inputs{display: flex; flex-direction: column; gap: 10px; justify-content: flex-end;}

                                        .dentadura .content .containerInputLabel{max-width: 200px; overflow-x: clip; position: relative; z-index: 1;}
                                        .dentadura .content .box{position: relative;z-index: 10;width: 100%;max-width: 420px;margin: 0 auto 0 0;padding: 5px 10px;}
                                            ...
                                            .dentadura .content .botaoCarrinho{cursor: pointer;max-width: 40px;width: 100%;height: 37px;cursor: pointer;border: solid 1px #6081af;border-radius: 10px;padding: 12px 5px 5px 5px;transition: all 0.3s ease-in;position: relative; margin: 0 10px 0 13px;}
                                                .dentadura .content .botaoCarrinho:hover{border: solid 1px #198119;}
                                                .dentadura .content .botaoCarrinho span{position: absolute; font-size: 10.5px; color: #ffffff; width: max-content; background-color: #0071cd; border-radius: 3px; padding: 0px 6px; line-height: 15px; top: -6px; left: -9px; transition: all 0.3s ease-in;}
                                                    .dentadura .content .botaoCarrinho:hover span{background-color: #198119;}
                                                .dentadura .content .botaoCarrinho svg{width: 90%;transition: all 0.2s ease-in;}
                                                    .dentadura .content .botaoCarrinho svg path{transition: all 0.3s ease-in;fill: #6081af;}
                                                        .dentadura .content .botaoCarrinho:hover svg path{fill: #198119;}
